  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-purple-900 to-indigo-900">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        {/* Prize Pool Card */}
        <div className="bg-gray-800 rounded-2xl shadow-xl p-8 mb-12 border border-purple-500/30">
          <div className="text-center mb-8">
            <h3 className="text-3xl font-bold text-white mb-2">Current Prize Pool</h3>
            <p className="text-gray-300">Week {prizePoolData?.currentWeek || 1}</p>
          </div>
          
          {loading ? (
            <div className="text-center py-12">
              <div className="animate-spin rounded-full h-12 w-12 border-b-2 border-pink-400 mx-auto"></div>
              <p className="mt-4 text-gray-300">Loading prize pool data...</p>
            </div>
          ) : (
            <div className="grid md:grid-cols-3 gap-8">
              ...
              <div className="text-center">
                ...
                <p className="text-gray-300">Participants This Week</p>
              </div>
              ...
              <div className="text-center">
                ...
                <p className="text-gray-300">Until Next Winner</p>
              </div>
            </div>
          )}
        </div>
      ...
      {/* Footer */}
      <footer className="bg-gray-800 py-6 mt-8 border-t border-purple-500/30">
